...
\usepackage{amsmath, amsthm, float, booktabs, amssymb, appendix, bm, graphicx, hyperref, mathrsfs,adjustbox,enumerate,colortbl,bbding,booktabs,subcaption,algorithm, algorithmic}
...
\subsection{单图}
\begin{figure*} [htbp!]
    \makebox[\textwidth][c]{\includegraphics[width=0.8\textwidth]{fig/chiji.png}}%使用此代码需注意图片比例，否则图片会被伸缩
